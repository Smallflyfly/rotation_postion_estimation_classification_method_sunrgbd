...
def demo(net, image_name):
    ...
    # Load the demo image
    im_file = os.path.join(cfg.DATA_DIR, 'sunrgbd_demo', image_name)
    # print(im_file)
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        cls_points2d = points2d[:, 16*cls_ind:16*(cls_ind+1)] # fang fangpengfei add cls_points2d

        # print(cls_boxes.shape) 300 * 4
        # print(cls_scores.shape) 300
        # print(cls_points2d.shape) 300 * 19
        # fang[-1]
        ...
        # print(dets.shape) 300 * 5
        # fang[-1]
        # dets =  np.hstack((dets, cls_points2d)).astype(float)
        # print(dets.shape)  # 300 * 24  300 * (4 + 1 + 19)
        # fang[-1]
        ...
        print('dets', dets)
        points2d = cls_points2d[keep.numpy(), :]
        print('points2d', points2d) #fang fangpengfei add fang
        # fang[-1]
